...
DASHBOARD_TITLE = "14-Day Flood Forecast for Huron River Watershed, Western Lake Erie Basin, Ohio"
...
WATERSHEDS = [
    ...
    },
    {
        ...
        "dashboard_title": "14-Day Flood Forecast for Sandusky River Watershed, Western Lake Erie Basin, Ohio",
  ...
  <body>
    <main>
      <section class="topbar" aria-label="Watershed selection">
        <div>
          <h1 class="main-title">Machine Learning-Based 14-Day Flood Forecast and Climate Comparison Dashboard</h1>
